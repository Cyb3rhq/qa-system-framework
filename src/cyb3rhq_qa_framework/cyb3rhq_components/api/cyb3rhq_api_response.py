"""
Module to wrapp the Cyb3rhq API responses. This modules contains the following:
...
class Cyb3rhqAPIResponse:
    """Wrapper class to handle Cyb3rhq API responses.
    ...
    Attributes:
        ...
        error (int): Cyb3rhq API response error.
        data (dict|str): Cyb3rhq API response data in dict format if possible else string.
    """
    ...
    def __get_data(self):
        ...
        Returns:
            (dict|str):  Cyb3rhq API response data in dict format if possible else string.
        """
